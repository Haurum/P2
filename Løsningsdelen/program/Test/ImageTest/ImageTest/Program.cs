...
namespace ImageTest
{
    static class Program
    {
        ...
        public static void ConvertLatLongToUTM(double dLong, double dLat, out double dY, out double dX)
        {
            //Read the inputs
            ...
            //CoordinatesConvertedLabel.Text += String.Format("{0} - {1} - {2}\n", dX.ToString("###,###,### meters"), dY.ToString("###,###,### meters"), Zone);

            //ImageTest.originalBitmap.SetPixel(15, 15, Color.Black);
        ...
        public static double ParseIn(string sIn)
        {
            sIn = sIn.Trim();
        ...
        //{
        //    //Attributes
        //    public static string ellipsoidName;
        //    public static double EquatorialRadius;
        //    public static double eccentricitySquared;

        //    public static Ellipsoid(string name, double radius, double ecc)
        //    {
        //        ellipsoidName = name;
